...
- Added new security feature where links with  will by default get rel="noopener noreferrer".
- Added new allow_unsafe_link_target to allow you to opt-out of the  security feature.
